...
s.author       = "Team"
s.platform     = :ios, "8.0"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '3.1.5'}
...
s.vendored_libraries = "libChartboostMediator.a"
s.dependency 'Chocolate_SDK', '~> 1.0.0'
s.dependency 'ChartboostSDK', '~> 7.0.3'
s.requires_arc = true
end
